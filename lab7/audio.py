...
music_files = [os.path.join(r"C:\Users\Данис\Desktop\anotherpp2\lab7\music", f) for f in os.listdir(r"C:\Users\Данис\Desktop\anotherpp2\lab7\music") if f.endswith(".mp3")]
current_song = 0
